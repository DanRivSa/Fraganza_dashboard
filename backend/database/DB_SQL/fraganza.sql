...
CREATE TABLE ada_otros_ing(
  id_oi SMALLINT,
  nombre_oi VARCHAR(15) NOT NULL UNIQUE,
  id_prov SMALLINT NOT NULL,
  tipo VARCHAR(10) NOT NULL,
  ipc INTEGER,
  cas INTEGER,
  CONSTRAINT PK_oi PRIMARY KEY (id_oi),
...
CREATE TABLE ada_otros_perfume(
id_perfume SMALLINT NOT NULL,
id_oi SMALLINT NOT NULL,
CONSTRAINT PK_otrosp PRIMARY KEY (id_perfume,id_oi)
);
...
id_prov SMALLINT,
id_prod SMALLINT,
CONSTRAINT PK_membresia PRIMARY KEY (fecha_inicio)
);
...
CONSTRAINT PK_apago PRIMARY KEY (id_prov,id_pago),
...
CONSTRAINT PK_ada_cuota PRIMARY KEY (id_prov,id_pago,id_cuota),
...
CONSTRAINT PK_altenvio PRIMARY KEY (id_prov,id_pais),
...
CONSTRAINT PK_modif_e PRIMARY KEY (id_prod,id_pais,id_modif),
...
id_pago SMALLINT NOT NULL,
CONSTRAINT PK_contrac_ap PRIMARY KEY (id_prod,id_prov,numero_contrato,id_prov2,id_pago)
);
...
CONSTRAINT PK_contrac_me PRIMARY KEY (id_prod,id_prov,numero_contrato,id_prov2,id_pais),
...
id_oi SMALLINT NOT NULL,
cas INTEGER,
CONSTRAINT PK_otro_e PRIMARY KEY (id_oi,cas)
);
