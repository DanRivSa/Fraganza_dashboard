...
CREATE SEQUENCE sec_id_otros_ing as SMALLINT
 ...
 MAXVALUE 100
 NO CYCLE
 OWNED BY ada_otros_ing.id_oi;
ALTER TABLE ada_otros_ing
ALTER COLUMN id_oi SET DEFAULT nextval('sec_id_otros_ing');
...
CREATE SEQUENCE sec_id_pago as SMALLINT
MINVALUE 1
MAXVALUE 50
NO CYCLE
OWNED BY ada_alternativa_pago.id_pago;
ALTER TABLE ada_alternativa_pago
ALTER COLUMN id_pago SET DEFAULT nextval('sec_id_pago');


CREATE SEQUENCE sec_id_cuota as SMALLINT
MINVALUE 1
MAXVALUE 25
NO CYCLE
OWNED BY ada_cuota.id_cuota;
ALTER TABLE ada_cuota
ALTER COLUMN id_cuota SET DEFAULT nextval('sec_id_cuota');
...
ALTER TABLE ada_otros_perfume
ADD CONSTRAINT FK_id_perfume FOREIGN KEY (id_perfume)
REFERENCES ada_perfume (id_perfume);
ALTER TABLE ada_otros_perfume
ADD CONSTRAINT FK_oi FOREIGN KEY (id_oi)
REFERENCES ada_otros_ing (id_oi);
...
ALTER TABLE ada_cuota
ADD CONSTRAINT FK_cuota FOREIGN KEY (id_pago,id_prov)
REFERENCES ada_alternativa_pago (id_pago,id_prov);
...
REFERENCES ada_esencia (cas);
ALTER TABLE ada_presentacion_e
ADD CONSTRAINT FK_id_oi FOREIGN KEY (id_oi)
REFERENCES ada_otros_ing (id_oi);
...
ALTER TABLE ada_modificador_envio
ADD CONSTRAINT FK_modif_e FOREIGN KEY(id_prod)
REFERENCES ada_productor (id_prod);
ALTER TABLE ada_modificador_envio
...
REFERENCES ada_contrato (id_prod,id_prov,numero_contrato);
ALTER TABLE ada_contratacion_ap
ADD CONSTRAINT FK_prov_pago FOREIGN KEY (id_prov2,id_pago)
REFERENCES ada_alternativa_pago (id_prov,id_pago);
...
REFERENCES ada_contrato (id_prod,id_prov,numero_contrato);
ALTER TABLE ada_contratacion_me
ADD CONSTRAINT FK_prov_pais FOREIGN KEY (id_prov2,id_pais)
REFERENCES ada_alternativa_envio (id_prov,id_pais);
...
FOREIGN KEY (id_prod1,id_prov1,numero_contrato1,id_prov2,id_pago)
REFERENCES ada_contratacion_ap (id_prod,id_prov,numero_contrato,id_prov2,id_pago);
ALTER TABLE ada_pedido
ADD CONSTRAINT FK_contrac_me
FOREIGN KEY(id_prod3,id_prov3,numero_contrato2,id_prov4,id_pais)
REFERENCES ada_contratacion_me (id_prod,id_prov,numero_contrato,id_prov2,id_pais);
